# series of functions to compute the power spectrum in various dimensions
# this can be merged with the file cmpspec to have a unique library with functions
# that they do the same things but differently
# REQUIRES COSMETIC AND REARRANGEMENTS ADJUSTMENT - COMPARE VARIOUS METHODS TO COMPUTE POWER SPECTRUM
