# collection of method to generate gaussian fields
# i can see extending this to generate vector field as well in the future maybe seperate file
# REQUIRES CHANGES IN ORGANISING THE METHODS fft and cosine (maybe seperate files) AND NAME CHANGES
