# This was originally the paraxial_solver.py file which computes the ray tracer algorithm
# for the simple 4 component description of the ray vectors - first version of the solver
