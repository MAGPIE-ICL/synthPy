...
sh = system_solve(remaining_rays,beam_size,divergence, field, extent_y, probing_direction, wl)
...
for i in range(number_of_splits):
    ...
    # Solve subsystem
    sh_split = system_solve(Np_ray_split,beam_size,divergence,field, extent_y, probing_direction, wl)
