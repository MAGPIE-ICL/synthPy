...
Run with the following job: 

recommend 100gb ram, 1 processor
...
for p in ps:
    for factor in factors:
        ...
        domain.export_scalar_field(fname = f'/rds/general/user/le322/home/synthPy/fields/length_scale_full/{str(p)}/{factor}') #insert path to save here
        del x
        del y
        del z
        del ne
