...
class ScalarDomain(eqx.Module):
    ...
    def __init__(self, lengths, dims, *, ne_type = None, phaseshift = False, B_on = False, probing_direction = 'z', auto_batching = True, iteration = 1, region_count = 1, leeway_factor = None, coord_backup = None, future_dims = None, extra_info = False, memory_reporting = False, memory_limit = None, Np = None,
...
def dsdt(t, s, ne, x, y, z, omega, lengths, dims, edensity, refrac_field):
